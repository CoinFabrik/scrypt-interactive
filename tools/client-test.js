...
const parity = new Web3(new Web3.providers.HttpProvider(process.env.WEB3_PARITY_PROVIDER))

const deployScryptRunner = require('../test/helpers/deployScryptRunner')
...
module.exports = async function (callback) {
  ...
  const scryptRunner = await deployScryptRunner(parity)
